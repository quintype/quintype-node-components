...
export class WithSocialLogin extends React.Component {
  constructor(props) {
    super(props);
    this.bridgekeeperServerLoginPath = `/api/auth/v1/login?auth-provider=${this.props.provider}&redirect-url=${this.props.redirectUrl ? this.props.redirectUrl : global.location && global.location.origin}`;
